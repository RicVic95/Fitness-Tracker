...
df = pd.read_pickle('../../data/interim/02_outliers_removed_cauvenets.pkl')
...
# Visualizing the change of the lowpass filter 
...
# This is done to reduce correlation between records to prevent overfitting of the model 
